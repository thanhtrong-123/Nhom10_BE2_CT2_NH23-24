...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //     'brand_name' => 'CLOWNZ',
        //     'brand_slug' => 'clownz',
        //     'brand_description' => 'Nếu như những thương hiệu trên đều mang một style riêng biệt thì ClownZ lại là nơi mà các tính đồ streetwear Hà Thành có thể tìm thấy tất cả những gì mình cần.Từ Baseball Jacket, Tee, Jogger Pants cho đến sneakers trong bức ảnh này đều có thể tìm thấy ở ClownZ.',
        //     'brand_status' => true,
        //     'created_at' => now(),
        //     'updated_at' => now()
        // ]);
        ...
        //     'brand_name' => 'DEGREY',
        //     'brand_slug' => 'degrey',
        //     'brand_description' => 'Degrey là một local brand giá rẻ được thành lập từ năm 2016 cho đến nay đã phát triển và được giới trẻ săn đón không chỉ bởi giá thành mà còn ở chất lượng sản phẩm.',
        //     'brand_status' => true,
        //     'created_at' => now(),
        //     'updated_at' => now()
        // ]);
        ...
        //     'category_description' => 'Áo thun, hay áo phông thường được dệt theo nốt jersey và bằng sợi cotton, đôi khi bằng chất liệu khác, tạo sự mềm mại đặc trưng. Áo thun có thể được trang trí bằng chữ và/hoặc hình ảnh thường dùng để quảng bá điều gì đó hoặc quảng cáo sản phẩm, công ty hoặc trang web.',
        ...
        //     'category_description' => 'Quần short là kiểu quần có chiều dài khoảng 5-7cm đến phía trên đầu gối, với thiết kế tương tự như quần thông thường, chỉ khác biệt chủ yếu ở độ dài. Việc lựa chọn chất liệu cho quần short rất đa dạng, từ kaki, thun, cotton đến lanh, đũi, tùy thuộc vào nhu cầu và mục đích sử dụng của mỗi người.',
        ...
        //     'category_description' => 'Áo hoodie là một loại áo nỉ có mũ trùm đầu che một phần hoặc toàn bộ đầu hoặc mặt của người mặc. Áo hoodie có khóa kéo thường có hai túi ở mặt trước phía dưới, một túi ở hai bên dây kéo, trong khi áo hoodie "áo thun" thường có một túi hoặc một túi bịt lớn duy nhất ở cùng một vị trí.',
        ...
        //     'category_description' => 'Áo khoác là loại trang phục dành cho phần thân trên, thường kéo dài đến dưới hông. Áo khoác thường có tay áo và buộc chặt ở phía trước hoặc hơi lệch sang một bên. Áo khoác thường nhẹ hơn, bó sát hơn và ít cách nhiệt hơn áo khoác ngoài. Một số áo khoác là thời trang, trong khi một số khác dùng làm quần áo bảo hộ.',
        ...
        //     'category_name' => 'Pants',
        //     'category_slug' => 'pants',
        //     'category_description' => 'Quần là một loại trang phục che phần thân dưới của con người. Quần có nhiều kiểu dáng và chất liệu khác nhau, được sử dụng cho nhiều mục đích và trong nhiều hoàn cảnh khác nhau.',
        ...
        //     'name' => 'Áo Thun Care & Share Pastel',
        //     'product_qty' => 10,
        //     'product_slug' => 'ao-thun-care-share-pastel',
        //     'price' => 199000,
        //     'image' => 'product01.jpg',
        //     'description' => 'Áo thun Care & Share Pastel có thiết kế tối giản, dễ mặc với dòng chữ trang trí màu Pastel lạ mắt ngay trên ngực áo.',
        ...
        // // 2
        // DB::table('products')->insert([
        //     'name' => 'Áo thun Stitch Summer Surfing',
        //     'product_qty' => 10,
        //     'product_slug' => 'ao-thun-stitch-summer-surfing',
        //     'price' => 249000,
        //     'image' => 'product02.jpg',
        //     'description' => 'Cảm hứng mùa hè từ nhân vật Stitch và một Hawaii nhiệt đới với những bãi biển mát mẻ, đầy nắng.',
        //     'product_content' => 'Áo được làm từ chất liệu 100% cotton mềm mại, co giãn, thấm hút mồ hôi tốt. Bên cạnh đó, định lượng vải 200gsm cũng giúp áo có độ dày dặn, bền bỉ hơn so với áo thun cotton thông thường. Áo có form dáng regular fit suông mà không quá thùng thình, mang đến cảm giác thoải mái và dễ chịu dù là đi tập, đi chơi, đi làm hay mặc ở nhà.',
        //     'category_id' => 1,
        //     'brand_id' => 2,
        //     'product_status' => true,
        ...
        // // 3
        // DB::table('products')->insert([
        //     'name' => 'Bear Icon T-Shirt',
        //     'product_qty' => 10,
        //     'product_slug' => 'bear-icon-t-shirt',
        //     'price' => 1260000,
        //     'image' => 'product03.jpg',
        //     'description' => 'Silicone Printed logo. DTF Printed Bear Icon on back. Traditional Red Logo Hang/tag. True to size. Order size down for tighter fit',
        ...
        // // 4
        // DB::table('products')->insert([
        //     'name' => 'CLOWNZ FLORAL T-SHIRT',
        //     'product_qty' => 10,
        //     'product_slug' => 'clown-floral-t-shirt',
        //     'price' => 280000,
        //     'image' => 'product04.jpg',
        //     'description' => 'Cảm hứng thiết kế : Mẫu T-shirt với graphic logo kèm text ClownZ được cách điệu và phối cùng với graphic hoa lá ở mặt trước, kết hợp với màu áo beige cực dễ phối đồ, tạo ra một vibe cực kỳ fresh và hợp với mùa hè.',
        ...
        // // 5
        // DB::table('products')->insert([
        //     'name' => 'ÁO THUN OVERSIZED RETRO LOGO',
        //     'product_qty' => 10,
        //     'product_slug' => 'ao-thun-oversized-retro-logo',
        //     'price' => 550000,
        //     'image' => 'product05.jpg',
        //     'description' => '100% COTTON. 320GSM. IN LỤA THỦ CÔNG. OVERSIZED FIT',
        ...
        //     'price' => 269000,
        //     'image' => 'product06.jpg',
        //     'description' => 'Quần nam Daily Shorts - sợi Sorona, nhuộm Cleandye',
        ...
        // // 7
        // DB::table('products')->insert([
        //     'name' => 'Quần Shorts Nam Thể Thao 9',
        //     'product_qty' => 10,
        //     'product_slug' => 'quan-shorts-nam-the-thao-9',
        //     'price' => 219000,
        //     'image' => 'product07.jpg',
        //     'description' => 'Chất liệu: 88% Polyester + 12% Spandex. Vải có khả năng thấm hút tốt và nhanh khô. Co giãn 4 chiều, thoải mái vận động. Túi to và sâu tiện lợi, thoải mái đựng đồ cá nhân. Có 1 túi khoá kéo ẩn, đựng vừa chìa khoá hay Airpods. Độ dài đo từ đũng đến viền ống quần: 9. Tự hào sản xuất tại Việt Nam',
        ...
        //     'price' => 1260000,
        //     'image' => 'product08.jpg',
        //     'description' => 'Polyester blend exterior. Mesh interior. Adjustable drawstring. 6.5" inseam. Rubber logo stitched on. Godson Brand ™ embroidered . Fit true to size',
        ...
        // // 9
        // DB::table('products')->insert([
        //     'name' => 'QUẦN SHORT KAKI ANGEL THÊU',
        //     'product_qty' => 10,
        //     'product_slug' => 'quan-short-kaki-angel-theu',
        //     'price' => 500000,
        //     'image' => 'product09.jpg',
        //     'description' => 'VẢI CHÍNH: 100% SỢI BÔNG COTTON. VẢI PHỤ: 100% SỢI BÔNG COTTON. TRANG TRÍ: THÊU VI TÍNH PHỤ LIỆU. DÂY KÉO YKK YKK ZIPPER. NÚT KIM LOẠI BOBUI BOBUI METALS BUTTON. KẸP KIM LOẠI BOBUI BOBUI METALS TAG. KIỂU DÁNG: RELAXED FIT',
        ...
        //     'price' => 339000,
        //     'image' => 'product10.jpg',
        //     'description' => 'Quần Shorts Nam Gym 7 Power tại Coolmate được thiết kế phù hợp với mọi hoạt động thể thao như tập gym, chạy bộ và các hoạt động thường ngày khác. Với chất liệu thấm hút mồ hôi, thoáng khí và mang lại thoải mái cho người mặc, đây thực sự là lựa chọn hoàn hảo cho những chàng trai yêu thể thao. ',
        ...
        // // 11
        // DB::table('products')->insert([
        //     'name' => 'Hoodie Degrey Is Us Kem - HDISK',
        //     'product_qty' => 10,
        //     'product_slug' => 'hoodie-degrey-is-us-kem-hdisk',
        //     'price' => 390000,
        //     'image' => 'product11.jpg',
        //     'description' => 'Chất liệu: Chân Cua 350gsm. Họa tiết: Được thêu trực tiếp lên sản phẩm. Size: S/ M/ L. Thương hiệu: Degrey. Sản xuất: Việt Nam. Màu sắc và họa tiết được thiết kế riêng bởi team design DEGREY',
        ...
        // // 13
        // DB::table('products')->insert([
        //     'name' => 'Three Heart Hoodie',
        //     'product_qty' => 10,
        //     'product_slug' => 'three-heart-hoodie',
        //     'price' => 1713000,
        //     'image' => 'product13.jpg',
        //     'description' => 'Three Heart Embroidery. Logo Stitched Patch on sleeve. Made With Patience Screen-print. Fits True To Size. 65% Premium Cotton/ 35% Polyester',
        ...
        // // 14
        // DB::table('products')->insert([
        //     'name' => 'CLOWNZ METAL BASIC HOODIE',
        //     'product_qty' => 10,
        //     'product_slug' => 'clownz-metal-basic-hoodie',
        //     'price' => 450000,
        //     'image' => 'product14.jpg',
        //     'description' => 'Cảm hứng thiết kế : Mẫu hoodie basic, form boxy, đặc biệt không sử dụng bo như các mẫu hoodie thông thường, với các đường may ghép vải ở mặt trước, kèm tag kim loại đúc chữ ClownZ màu bạc nhám. Sử dụng chun có chốt màu gun metal ở các vị trí : gấu áo, cửa tay, mũ, hoodie này còn có thêm đinh tán ở các vị trí góc túi bụng tạo điểm nhấn.',
        ...
        // // 15
        // DB::table('products')->insert([
        //     'name' => 'CLOWNZ LONG LONELY HOODIE',
        //     'product_qty' => 10,
        //     'product_slug' => 'clownz-long-lonely-hoodie',
        //     'price' => 500000,
        //     'image' => 'product15.jpg',
        //     'description' => 'Cảm hứng thiết kế : nằm trong BST F/W 2023 - Synthetic Realms của ClownZ, với dòng quote được lấy cảm hứng từ bộ phim Blade Runner 2049, được in to ở mặt trước. Túi bụng được thiết kế ẩn ở bên sườn áo, tạo cảm giác tinh tế khi sử dụng, đi cùng form boxy.',
        ...
        // // 16
        // DB::table('products')->insert([
        //     'name' => 'ÁO KHOÁC DÙ LAST JUDGEMENT',
        //     'product_qty' => 10,
        //     'product_slug' => 'ao-khoac-du-last-judgement',
        //     'price' => 1500000,
        //     'image' => 'product16.jpg',
        //     'description' => 'VẢI CHÍNH: 90% NYLON 10% SPANDEX. VẢI PHỤ: 100% POLYESTER. TRANG TRÍ:. "LAST JUDGEMENT" IN NHIỆT. MÓC KHÓA THIÊN THẦN BẠC. DÂY KÉO YKK YKK ZIPPER. FORM ÁO RỘNG',
        ...
        // // 18
        // DB::table('products')->insert([
        //     'name' => 'Áo Khoác Nam gió Thể Thao phối màu',
        //     'product_qty' => 10,
        ...
        // // 19
        // DB::table('products')->insert([
        //     'name' => 'CLOWNZ CORDUROY HOOD JACKET',
        //     'product_qty' => 10,
        //     'product_slug' => 'clownz-corduroy-hood-jacket',
        //     'price' => 550000,
        //     'image' => 'product19.jpg',
        //     'description' => 'Cảm hứng thiết kế : khóa 2 chiều tiện lợi, chất liệu nhung tăm, có thêm lót 1 lớp vải gió giúp áo không bị quá nặng nhưng vẫn rất ấm áp, phù hợp với thời tiết mùa xuân. Với kiểu dáng thiết kế basic, mặt trước được thêu chữ ClownZ tinh tế.',
        ...
        // // 20
        // DB::table('products')->insert([
        //     'name' => 'Áo khoác da Degrey.Madmonks Biker Jacket',
        //     'product_qty' => 10,
        //     'product_slug' => 'ao-khoac-da-degrey.madmonks-biker-jacket',
        //     'price' => 1200000,
        //     'image' => 'product20.jpg',
        //     'description' => 'Chất liệu: da PVC. Hoạ tiết: Được may trực tiếp lên sản phẩm cực ngầu. Thương hiệu: Degrey. Sản xuất: Việt Nam. Màu sắc và họa tiết được thiết kế riêng bởi team design DEGREY',
        ...
        //     'price' => 499000,
        //     'image' => 'product21.jpg',
        //     'description' => 'Quần Dài Nam Kaki Excool dáng straight ống rộng cực kì tiện lợi và thoải mái. Với nhiều đặc tính nổi trội từ sợi sorona tự nhiên, đây chắc chắn là một chiếc quần của nhà Coolmate mà chàng nên có trong tủ quần áo của mình đấy.',
        ...
        //     'price' => 499000,
        //     'image' => 'product22.jpg',
        //     'description' => 'Quần Jeans Nam Basics dáng straight ống rộng cực kì tiện lợi và thoải mái. Với nhiều đặc tính nổi trội từ sợi sorona tự nhiên, đây chắc chắn là một chiếc quần của nhà Coolmate mà chàng nên có trong tủ quần áo của mình đấy.',
        ...
        // // 23
        // DB::table('products')->insert([
        //     'name' => 'Perception Sweatpants',
        //     'product_qty' => 10,
        //     'product_slug' => 'perception-sweatpants',
        //     'price' => 1889000,
        //     'image' => 'product23.jpg',
        //     'description' => 'Lightweight Spring Sweatpants. Puff Print (3D) Godson Brand ™ Logo on right leg. Screenprint concept message "For those who seek a higher power. Communication, trust & love". MADE WITH PERCEPTION. 65% Cotton. 35% Polyester . True to size, order normal size',
        ...
        // // 24
        // DB::table('products')->insert([
        //     'name' => 'CLOWNZ KAKI STRAIGHT PANTS V2',
        //     'product_qty' => 10,
        //     'product_slug' => 'cownz-kaki-straight-pants-v2',
        //     'price' => 320000,
        //     'image' => 'product24.jpg',
        //     'description' => 'Cảm hứng thiết kế : Mẫu quần kaki ống xuông với các chi tiết túi ở mặt sau, và có túi ẩn kèm khóa zip. Một mẫu quần kaki xuông basic có thể phối được với hầu hết các items trong tủ đồ của bạn.',
        ...
        // // 25
        // DB::table('products')->insert([
        //     'name' => 'QUẦN JEANS THIÊN THẦN PHUN SƠN MÀU XANH',
        //     'product_qty' => 10,
        //     'product_slug' => 'quan-jeans-thien-than-phun-son-mau-xanh',
        //     'price' => 650000,
        //     'image' => 'product25.jpg',
        //     'description' => 'HỌA TIÊT THIỀN THẦN: KÉO LỤA THỦ CÔNG. HỌA TIẾT CUSTOM ANGEL: PHUN SƠN THỦ CÔNG. TRANG TRÍ: NÚT KIM LOẠI, DÂY KÉO YKK, NHÃN DA BOBỤI. VẢI CHÍNH: 100% SỢI BÔNG COTTON',
        ...
        // // 26
        // // DB::table('products')->insert([
        // //     'name' => 'Áo thun Degrey thiết kế 2 lớp Signature Degrey double tee - SIG',
        // //     'product_qty' => 10,
        // //     'product_slug' => 'ao-thun-degrey-thiet-ke-2-lop-signature-degrey-double-tee-sig',
        // //     'price' => 350000,
        // //     'image' => 'product26.jpg',
        // //     'description' => 'Chất liệu: 250gsm, cotton 2 chiều. Họa tiết: Được In lụa. Size: S/M/L. Thương hiệu: Degrey. Sản xuất: Việt Nam. Màu sắc và họa tiết được thiết kế riêng bởi team design DEGREY',
