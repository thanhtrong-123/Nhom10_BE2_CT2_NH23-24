                ...
                <div class="col-md-8 col-lg-9">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="tab-dashboard" role="tabpanel"
                            ...
                            <p style="font-size:18px;">Hello <span
                                    class="font-weight-normal text-dark" style="font-size:22px;">{{ Session::get('customer_name') }}</span> (not
                                <span style="font-size:22px;" class="font-weight-normal text-dark">{{ Session::get('customer_name') }}</span>? <a href="{{ URL::to('/logoutuser') }}">Log out</a>)
                                <br>
