                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form role="form" action="{{URL::to('/categoryProduct')}}" method="post">
                                    {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="slug_category_product" class="form-control" id="convert_slug" placeholder="Tên danh mục" readonly>
                                </div>
                                <div class="form-group">
