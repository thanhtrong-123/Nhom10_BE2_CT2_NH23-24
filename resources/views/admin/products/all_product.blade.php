                ...
                <div class="form-group">
                    <form action="/searchproduct" method="get">
                        <div class="input-group">
                            <input class="input-sm form-control" placeholder="Search" name="searchproduct">
            ...
            <table class="table table-striped b-t b-light">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="{{ asset('storage/images/products/' . $value->product_image) }}"
                                alt="Hình sản phẩm" style="width: 50px;"></td>
                ...
                ?>
                        ...
                        <td>
                            <div class="edit"
                                ...
                                <a style="pading: 10px;"
                                    href="{{ URL::to('products/' . $value->product_id . '/edit') }}"
